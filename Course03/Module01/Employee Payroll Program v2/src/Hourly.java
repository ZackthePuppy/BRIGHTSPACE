...
public class Hourly extends Employee {
        ...
        while (true) {
            ...
            try {
                ...
                if (hourlyPay <= 0 || hoursWorked <= 0) { // executes if user entered zero/negative numbers.
                    ...
                    go.pauseClear();
                    go.printBox("PROFILE FOR EMPLOYEE #" + empNumber); // prints a title so that the user still knows
                                                                       // the employee number
                }
    ...
    public double getEarnings() {
        ...
        if (this.hoursWorked > 40) {
            ...
            hourlyPayCheck += (this.hoursWorked - overTime) * halfHourly; // adds the overtime hours in paycheck.
                                                                          // overtime hour * half of hourlypay
        } else {
